...
Train_rossman = read_csv("train.csv",col_names = TRUE,col_types = list(
  Store = col_integer(),
  ...
  SchoolHoliday = col_character()))
Train_store = read_csv("store.csv",col_names = TRUE,col_types = list(
  Store = col_integer(),
  ...
  Promo2 = col_integer(),
  Promo2SinceWeek = col_integer(),
  Promo2SinceYear = col_integer(),
  PromoInterval = col_character()
))
Test_rossman = read_csv("test.csv",col_names = TRUE,col_types = list(
  Id = col_integer(),
  Store = col_integer(),
  DayOfWeek = col_integer(),
  Date = col_date(format = ""),
...
Total_combined$CompetitionOpenSinceMonth[is.na(Total_combined$CompetitionOpenSinceMonth)] = 0
...
Total_combined$CompetitionOpenSinceYear[is.na(Total_combined$CompetitionOpenSinceYear)] = 0
...
# PREDICTIONS MORE SKEWED AND IT WAS MENTIONED IN THE COMPETITION TO REMOVED THEM.

Train_total2 = Train_total[Train_total$Sales > 0,]
...
library(h2o)
h2o_init = h2o.init(nthreads = 8,max_mem_size = "20g")
...
RF_Train_sample_h2o = h2o.randomForest(x = names(Train_sample),y = "Sales",
...
# HAS BEEN HARD TO DO. HENCE THE RMSPE ENDED UP AT 0.16. WITH ENOUGH COMPUTATIONAL POWER THIS CAN 
